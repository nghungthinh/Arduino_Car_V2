...
#include "Arduino.h"
uint8_t IN1, IN2, IN3, IN4, sensor_l, sensor_m, sensor_r;

void Write_Pin(uint8_t IN_1, uint8_t IN_2, uint8_t IN_3, uint8_t IN_4, uint8_t IR_LEFT, uint8_t IR_MID, uint8_t IR_RIGHT)
{
  IN1 = IN_1;
  IN2 = IN_2;
  IN3 = IN_3;
